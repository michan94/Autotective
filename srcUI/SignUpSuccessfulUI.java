 ...
 * @author Charlotte
 */
public class SignUpSuccessfulUI extends javax.swing.JFrame {

    /**
     * Creates new form SignUpSuccessfulUI
     */
    public SignUpSuccessfulUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sign Up Successful!");
        ...
        jButton2.getAccessibleContext().setAccessibleName("btnReturnToLogin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpSuccessfulUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignUpSuccessfulUI().setVisible(true);
            }
        });
    }
