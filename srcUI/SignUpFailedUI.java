 ...
 * @author Charlotte
 */
public class SignUpFailedUI extends javax.swing.JFrame {

    /**
     * Creates new form SignUpFailedUI
     */
    public SignUpFailedUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Username Taken!");
        ...
        jButton2.getAccessibleContext().setAccessibleName("btnTryAgain");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpFailedUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignUpFailedUI().setVisible(true);
            }
        });
    }
