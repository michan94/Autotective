...
public class AddCarUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.getAccessibleContext().setAccessibleName("tAddCar");
        jButton2.getAccessibleContext().setAccessibleName("btnAdd");
        jButton3.getAccessibleContext().setAccessibleName("bCancel");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCarUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
