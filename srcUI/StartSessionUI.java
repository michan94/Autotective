...
public class StartSessionUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setFont(new java.awt.Font("Heiti SC", 0, 13)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "s0", "s1", "s2", "s3", "s4" }));

        jLabel5.setFont(new java.awt.Font("Heiti SC", 1, 24)); // NOI18N
        jLabel5.setText("Car not here?");
        ...
        jLabel2.getAccessibleContext().setAccessibleName("tSetting");
        jComboBox2.getAccessibleContext().setAccessibleName("sMenu");
        jLabel5.getAccessibleContext().setAccessibleName("tCarNotHere");
        jButton3.getAccessibleContext().setAccessibleName("btnAddNewCar");
